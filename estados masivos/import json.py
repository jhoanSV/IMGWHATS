...
import os
import numpy as np
from ImgTrandformation import PImage, PText
...
# *List of Clients
CLient = ['17','27','28','46','140','144','157','433']
...
for cli in CLient:
    ...
    for ImageProperty in I_properties:
        ...
        if ImageProperty['Type'] == 'image':
            ...
            bla = PImage(fil)
            print(cli ,bla.get_principal_color())
            ...
            replacedText = text.Text_replace({"@holi":0},["Un saludo muy especial"]) 
            fontSizeBox = TextBoxSize(boxWidth, boxHeight, replacedText, fontType)
            lines = replacedText.splitlines()
            ...
            h = font.getbbox(replacedText)[1] * len(lines)
            ...
            draw.multiline_text((x, y), replacedText, font=font, fill=fontColor, align=alingType)
